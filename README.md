...
- Soy estudiante avanzado de Ingeniería en Mecatrónica (2 materias restantes) y actualmente me encuentro explorando diferentes áreas de la programación, siempre estoy buscando aprender algo nuevo.
...
### Simulador de Extintor en Realidad Virtual
Se desarrolló un simulador inmersivo de uso de extintores en Unity para visores Meta Quest 3, incorporando la tecnología de Hand Tracking 2.0 para operar sin controladores físicos.
El sistema integra interacciones bimanuales asimétricas personalizadas (como hacer un puño para tomar la manija y un pellizco para retirar el precinto de seguridad), así como un modelo dinámico de colisión de partículas que calcula la "salud" del fuego frente al gas para una extinción realista. 
